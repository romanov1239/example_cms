...
<table id="Table_02" width="640" border="0" cellpadding="0" cellspacing="0" style="margin: auto; display: block;">
    ...
    <tr>
        ...
        <td width="510" height="366" style="display: inline-block; background-color: #fffff; padding: 0px 40px 0 60px">
          ...
          <p style="  font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: left; font-size: 16px; line-height: 22px; color: #5c646e; margin: 0px 0px 28px; letter-spacing: -0.2px;">
            Вы получили это письмо, так как нам поступил запрос на восстановление Вашего пароля на сайте <?= $domain_name ?>.
          </p>
          <p style="  font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: left; font-size: 16px; line-height: 22px; color: #5c646e; margin: 0px 0px 28px; letter-spacing: -0.2px;">
            Для обновления пароля, пожалуйста, перейдите по ссылке: <a target="_blank" href="<?= $resetLink ?>" style="text-decoration: none; color: #5c646e;"><?= $resetLink ?></a>
          </p>
          <p style="  font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: left; font-size: 16px; line-height: 22px; color: #5c646e; margin: 0px 0px 28px; letter-spacing: -0.2px;">
